      ...
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="md:w-1/2 lg:w-5/12 w-full">
            <div className="relative rounded-xl overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-orange-900/40 to-transparent flex items-end">
                {/* <div className="p-6">
                  <h3 className="text-white text-2xl font-bold mb-2">Just slip into it and forget period woes</h3>
                  <p className="text-white/90">With Orange Lilies Disposable Panties, there's no fuss, no stress.</p>
                </div> */}
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-md">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold mb-2 font-serif">No pad shifting, no frequent changes</h3>
